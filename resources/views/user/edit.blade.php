                        ...
                        @method('PUT')
                            <div class="block mt-3">
                                ...
                                <input type="text" class="
                                  ...
                                  " placeholder="Name User" name="name" id="name" value="{{$user->name}}" required>
                            </div>
                            <div class="block mt-3">
                                ...
                                <input type="email" class="
                                    ...
                                    border-0 border-b-2 border-gray-200
                                    bg-gray-300
                                  " placeholder="john@example.com" name="email" id="email" value="{{$user->email}}" disabled>
                            </div>
                            <div class="block mt-3">
                                ...
                                <select name="role" aria-label="label for the select" class="block w-full mt-0 px-0.5 border-0 border-b-2 border-gray-200 focus:ring-0 focus:border-black" id="">
                                    @foreach ($roles as $item)
                                        <option value="{{$item}}" {{$user->roles[0]->name == $item ? 'selected' : ''}}>{{$item}}</option>
                                    @endforeach
                                </select>
                            </div>
